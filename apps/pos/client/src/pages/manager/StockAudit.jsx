    ...
    <div className="min-h-screen bg-[var(--pos-page-bg)]">
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        <PageHeader
          ...
          subtitle="Conduct physical stock counts and submit adjustments to correct quantities."
          actions={[
            {
              label: 'Submit Audit',
              icon: Save,
        ...
        {/* Search Bar / Refresh */}
        <div className="flex items-center gap-3 mb-6 bg-[var(--pos-panel)] rounded-xl border border-slate-700/50 p-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-[var(--pos-surface-inset)] border border-slate-700 text-[var(--pos-text-primary)] rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 placeholder-slate-600"
            />
          </div>
          <button
            onClick={() => refetch()}
            ...
            columns={[
              ...
              },
              {
                ...
                render: (item) => {
                  ...
                  if (val === undefined || val === '') return <span className="text-slate-600">—</span>;
