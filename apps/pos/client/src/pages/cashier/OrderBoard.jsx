                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0 flex-1">
                    ...
                    {item.modifiers && item.modifiers.length > 0 && (
                      <div className="ml-3.5 pl-1.5 mt-0.5 space-y-0.5 border-l border-slate-700/20">
                        {item.modifiers.map((mod, j) => (
                          <span key={j} className="text-[10px] text-[var(--pos-text-muted)] block leading-tight font-medium">
                            ↳ + {mod.name}
                          </span>
                        ))}
                      </div>
