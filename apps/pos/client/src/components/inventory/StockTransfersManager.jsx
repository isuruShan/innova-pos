          ...
          <div className="border border-gray-200 rounded-2xl p-4 bg-gray-50/50 space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-3 flex gap-2 items-end shadow-sm">
              <div className="flex-1 min-w-0">
                <label className="block text-[10px] text-gray-550 font-bold mb-1">Select Item</label>
                <select
              ...
              <div className="w-24">
                <label className="block text-[10px] text-gray-550 font-bold mb-1">Ship Qty</label>
                <input
                  type="number"
                  step="0.01"
                  min="0.01"
        ...
        >
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm divide-y divide-gray-150">
              <div className="px-3 py-2 bg-gray-55 text-[10px] font-bold text-gray-550 grid grid-cols-12 gap-2">
