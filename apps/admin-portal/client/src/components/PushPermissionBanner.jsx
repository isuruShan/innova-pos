...
/**
 * Dismissible banner prompting admin portal users to enable push notifications.
      ...
      <div className="push-permission-banner__inner">
        ...
        <div className="push-permission-banner__content">
          ...
          <span className="push-permission-banner__body">
            Enable notifications to get instant alerts for subscription events, merchant activity, and platform updates.
          </span>
        </div>
